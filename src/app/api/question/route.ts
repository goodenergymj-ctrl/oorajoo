  ...
  try {
    ...
    const res = await fetch('https://api.anthropic.com/v1/messages', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'user',
          content: `자기성장 30일 챌린지 참여자를 위한 오늘의 성찰 질문 하나를 만들어줘. 오늘 날짜: ${today}. 25자 이내, 존댓말, 물음표로 끝나게. 미래지향적이고 긍정적인 내용만. 매일 다른 주제(관계/꿈/습관/감사/성장/용기/현재순간 등)를 골고루 다뤄야 해. 부정적 뉘앙스 절대 금지. 진부한 표현 피하기. 질문만 출력해.`
        }]
      })
    })
